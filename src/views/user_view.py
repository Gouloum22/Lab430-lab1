...
class UserView:
    ...
    def show_options():
        ...
        while True:
            ...
            "\n5. Supprimer tout les utilisateurs"
            "\n6. Quitter l'appli")
            ...
            if choice == '1':
                ...
                name, email = UserView.get_inputs_create()
    ...
    def get_inputs_update():
        """ Prompt user for inputs necessary to modify a user """
        id = input("\nID de lutilisateur a modifier: ").strip()
        name = input("\nNouveau nom d'utilisateur: ").strip()
    ...
    def get_inputs_delete():
        """ Prompt user for inputs necessary to modify a user """
        user_id = input("\nID de l'utilisateur a supprimer : ").strip()
        return user_id
